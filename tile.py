...
class QuantumTile:
    ...
    def __init__(self, raw_positions: list[Position], rotated_raw_positions: list[Position] = []) -> None:
    ...
    @staticmethod
    def getTiles(raw_positions: list[Position], positions: list[Position], id: int) -> list[Tile]:
        tile_list: list[Tile] = []
    ...
    def get_possible_tiles_at(self, position: Position) -> list[Tile]:
        ...
        tile_list += QuantumTile.getTiles(self.rotated_raw_positions, self.rotated_positions, self.id)
...
class QuantumTileMaker:
    ...
    def get2x1() -> QuantumTile:
        tile = QuantumTile([Position(0,0), Position(1,0)], [Position(0,0), Position(0,1)])
        return tile
    
    def get3x1() -> QuantumTile:
        tile = QuantumTile([Position(0,0), Position(1,0), Position(2,0)], [Position(0,0), Position(0,1), Position(0,2)])
        return tile
    
    def get2x2() -> QuantumTile:
        tile = QuantumTile([Position(0,0), Position(1,0), Position(0,1), Position(1,1)])
        return tile
    
    def get3x2() -> QuantumTile:
        tile = QuantumTile([Position(0,0), Position(1,0), Position(2,0), Position(0,1), Position(1,1), Position(2,1)], [Position(0,0), Position(0,1), Position(0,2), Position(1,0), Position(1,1), Position(1,2)])
        return tile