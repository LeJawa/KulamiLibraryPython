...
from board import BoardMaker, get_scores
...
class Kulami:
    ...
    def initialize_standard_board(self) -> None:
        ...
        kulami_rules.calculate_possible_moves(self)
    ...
    def player_turn(self) -> None:
        ...
        game_info = GameInfo(current_player=current_player, possible_moves=self.possible_moves, board=self.board)
...
if __name__ == "__main__":
    game = Kulami(NaivePlayer(), RandomPlayer())
